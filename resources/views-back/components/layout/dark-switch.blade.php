<div x-data="{ darkMode: false }" :class="{ 'dark': darkMode, '': !darkMode }">
    <div class="flex absolute w-64 h-16 items-end justify-center z-10" :class="{'mt-4':darkMode, 'mt-3':!darkMode}">
        <button @click="darkMode = !darkMode" x-show="darkMode">
        ...
        <button @click="darkMode = !darkMode" x-show="!darkMode" x-cloak>
