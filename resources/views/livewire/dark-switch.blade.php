<div x-data="{dark: false}" class="flex w-8 h-16 items-center justify-end z-10" x-on:dark.window="dark = $event.detail" x-cloak>
    <button @click="$dispatch('dark', false)" :class="{'block':dark, 'hidden':!dark}" class="focus:outline-none">
    ...
    <button @click="$dispatch('dark', true)" :class="{'hidden':dark, 'block':!dark}" class="focus:outline-none">
